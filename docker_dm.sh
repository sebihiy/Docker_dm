...
sed -i -e "s/ExecStart/ExecStart=\/usr\/bin\/dockerd --storage-driver=devicemapper --storage-opt=dm.thinpooldev=\/dev\/mapper\/data-pooldata --storage-opt dm.use_deferred_removal=true/g" /usr/lib/systemd/system/docker.service
